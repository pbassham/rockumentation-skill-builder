---
description: "Use when configuring check-in kiosk platforms, comparing browser vs iPad vs Windows applications, or setting up printing for Rock's NextGen check-in system"
source: "https://community.rockrms.com/documentation/bookcontent/42/350"
sourceLabel: Checking-out Check-in - NextGen
---
> **Path:** Checking-out Check-in - NextGen > Check-In Kiosk Options

Check-In Kiosk Options

The easiest way to run Rock's check-in system is to simply open a web browser on a desktop or tablet and navigate to `http://[yourserver]/nextgen-checkin`. Rock also provides a native iPad application and a Windows application. Let's explore the different strengths of these three platforms.

| Platform | Print From Server | Local Network Printing | Local USB Printing | Bluetooth printing | Notes |
| --- | --- | --- | --- | --- | --- |
| Browser-Based | X |  |  |  | The easiest method for running check-in, but all printing must be done from the server. (This will only work if your server is on the same network as the printers or you are using the [Rock Cloud Printing](#creatingcustomlabels) feature.) |
...
If your Rock server is hosted outside your organization, you will need to use the iPad application / Windows application to enable local printing, or the [Rock Cloud Printing](#creatingcustomlabels) feature.
...
After installing the application from the App Store and running it for the first time, you'll be prompted to enter the address of the check-in start page you want to use for the application. For most organizations this address will be `https://[your-rock-server]/nextgen-checkin`.

![iPad Launch Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/ipad-checkin-launch-configuration-v18.png)
...
![iPad Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/ipad-app-settings-v11.png)
...
![iPad bluetooth Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/ipad-app-settings-with-camera-v13.png)
...
![Device Camera Setup](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/ipad-camera-device-setup-v18.png)
...
![Welcome Block Settings](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/welcome-page-block-settings-camera-v18.png)
...
![Welcome Screen with Barcode Button](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/welcome-screen-with-barcode-button.png)
...
![Camera View](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/ipad-app-scanning-qr-code.png)
...
![Windows Client Check-In](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/windows-client-check-in.png)
...
Don't forget that QR code scanning to identify the person is supported in the Windows application. For details on setting up your device to enable this feature see the [Kiosks](#kiosks) chapter above. Note that scanning of QR codes generated by [\[Classic\] Mobile Check-in](https://community.rockrms.com/documentation/bookcontent/10/#mobilecheckin) is still limited to iPads only.
...
For instance, if your check-in URL is `examplechurch.com/nextgen-checkin`, you could use the URL `examplechurch.com/nextgen-checkin/setup?KioskId=2&CheckinConfigId=14&GroupTypeIds=18,19` to load the kiosk with the ID of `2`, use the check-in configuration with an ID of `14`, and group types with IDs of `18` and `19`. This is really useful if you have specific devices that always load the same configuration.

However, what if you have a lot of kiosk devices? It can be impractical to provide a unique URL to every kiosk, even if you want all of them to use the same check-in configuration. Luckily, Rock can go get the kiosk ID for you. If a CheckinConfigId is passed into the Check-in Admin block but a KioskId is not passed in, Rock will attempt to look up the KioskId for you using the client's IP address to find a matching Device in Rock. So, you would use a URL of `examplechurch.com/nextgen-checkin/setup?CheckinConfigId=14&GroupTypeIds=18,19` to enable the kiosk lookup.
...
> **Path:** Checking-out Check-in - NextGen > Going Deeper With Areas
...
> **Path:** Checking-out Check-in - NextGen > Check-In Test Area
...
> **Path:** Checking-out Check-in - NextGen > Beyond Children's Check-In
...
![Configuring Serving Groups For Checkin](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/configure-serving-groups-v18.png)
...
![Configuring A New Group Type For Checkin](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/configure-group-type-for-checkin-v18.png)
...
> **Path:** Checking-out Check-in - NextGen > Rapid Attendance Entry
...
![Rapid Attendance Entry Screen](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rapid-attendance-entry-contact-entry-v18.png)
...
![Rapid Attendance Entry Search](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rapid-attendance-entry-search-v18.png)
...
![Attendance and Contact Entry](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rapid-attendance-entry-results-decker-v18.png)
...
![Block Settings - General and Attendance](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rae-block-settings-general-attendance-v18.png)

Block Settings - General and Attendance

![Block Settings - Family and Individual](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rae-block-settings-family-individual-v18.png)

Block Settings - Family and Individual

![Block Settings - Notes, Prayers and Workflows](https://rockrms.blob.core.windows.net/documentation/Books/42/1.18.0/images/rae-block-settings-notes-prayer-workflow-v18.png)
