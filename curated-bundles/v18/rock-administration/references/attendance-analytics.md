---
description: "Use when analyzing attendance patterns, viewing attendee counts over time, filtering first-time visitors, or generating attendance reports for groups"
source: "https://community.rockrms.com/documentation/bookcontent/10/372"
sourceLabel: Checking-out Check-in
---
> **Path:** Checking-out Check-in > Attendance Analytics
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-chart-v13.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-attendees-v13.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-byvisit-v13.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-pattern-v13.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-reporting-block-settings-v13.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-additional-options-v13.png)
...
![Final Pieces](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/attendance-analytics-final-pieces-v13.png)
...
> **Path:** Checking-out Check-in > Printers
...
![Printer Details](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/printer-device-detail-v17.png)
...
> **Path:** Checking-out Check-in > Check-In Relationships
