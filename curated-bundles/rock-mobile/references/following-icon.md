---
description: Use when implementing a follow/unfollow toggle icon for content items in Rock Mobile apps that tracks user preferences
...
| PurposeKey   M v2.0C v12.4 | string | The key to identify a custom purpose to the following. *Defaults to* *null**.* |
