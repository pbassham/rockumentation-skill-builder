---
description: "Use when users need to initiate phone calls, send emails, or compose text messages from within an application"
...
| ShareAsFile   M v2.0 | boolean | Indicates that the Uri should be downloaded to the device and then shared as a file so other applications on the device can be used to open the file. |
