---
description: "Use when building mobile app features that play audio or video files in full-screen with customizable parameters like titles, thumbnails, and player controls"
