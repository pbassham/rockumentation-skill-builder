...
This block only allows edit of attributes with field types that are supported in the mobile shell. You can view the [Supported Field Types](https://community.rockrms.com/developer/mobile-docs/essentials/field-types) section to see which are currently supported.  
...
![](https://community.rockrms.com/GetImage.ashx?Id=71447)
