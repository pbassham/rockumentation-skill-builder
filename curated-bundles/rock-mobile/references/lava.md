---
description: "Use when building Rock Mobile experiences with Lava templating, filters, whitespace optimization, or accessing shell variables like PageParameter and CurrentPerson"
...
## Context in Lava {#context-in-lava}
