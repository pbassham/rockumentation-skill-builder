---
description: "Use when a user needs guidance on configuring the account onboarding flow for Rock mobile apps, including verification, demographics, campus, and notification preferences setup"
...
Rock Mobile offers a full-featured real-time chat experience with support for threads, reactions, media, group messaging and more.
