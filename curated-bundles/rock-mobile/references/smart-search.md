---
description: "Use when implementing multi-component search functionality to find people by birthdate, name, email, address or groups by name with configurable results display"
...
![](https://community.rockrms.com/GetImage.ashx?Id=71450)
