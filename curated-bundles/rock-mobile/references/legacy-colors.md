---
description: "Use when you need to configure color schemes, hex color values, interface colors, or access predefined color palettes for Rock mobile applications"
