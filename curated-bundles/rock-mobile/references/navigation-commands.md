---
description: "Use when needing to configure page navigation behavior (Push, Replace, Show modes) or implement commands to open maps, app settings, or browser links in mobile apps"
