---
description: "Use when implementing a search interface with configurable search components, result templates, and search history display functionality in Rock Mobile"
