---
description: "Use when a user needs to configure or understand the login block for a Rock mobile application, including authentication settings and page navigation"
