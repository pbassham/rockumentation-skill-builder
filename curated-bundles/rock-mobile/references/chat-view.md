---
description: "Use when a user needs help setting up or using real-time chat messaging in Rock Mobile, including channels, direct messages, threads, and group communications"
