---
description: "Use when explaining different digital check-in system types, their advantages, disadvantages, or helping choose between centralized self-service, decentralized, and attended check-in models"
source: "https://community.rockrms.com/documentation/bookcontent/42/350"
sourceLabel: Checking-out Check-in - NextGen
---
> **Path:** Checking-out Check-in - NextGen > Check-In Systems
...
## Checking-out Check-in - NextGen {#checking-out-check-in-nextgen}

> **Path:** Checking-out Check-in - NextGen

This skill catalogs the chapters of *Checking-out Check-in - NextGen* from the Rock RMS documentation.
...
> **Path:** Checking-out Check-in - NextGen > Welcome
...
> **Path:** Checking-out Check-in - NextGen > Check-In Processes Available in Rock
...
> **Path:** Checking-out Check-in - NextGen > Learning the Lingo
...
| Term | Definition |
| --- | --- |
| Check-in Configurations | A check-in configuration is what you start with when configuring check-in. All the settings are associated with a particular configuration. When you start a check-in kiosk, one of the first things you'll be asked is which check-in configuration to use. Examples of check-in configurations include Volunteer Check-In and Weekly Service Check-In (for kids).  These are also sometimes referred to as *Check-in Types* or *Check-in Configuration Templates*. |
...
> **Path:** Checking-out Check-in - NextGen > Individual and Family Check-In in Rock
...
![Check-in Overview](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/checkin-overview.png)
...
![Family Check-In Walkthrough](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/family-walkthrough.png)
...
> **Path:** Checking-out Check-in - NextGen > The Administration Screen
...
![Admin Screen](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/walkthru-1.png)
...
- Areas
![Check-in Options](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/walkthru-1-b.png)

Check-in Administration Options
...
![Save New Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/walkthru-1-c.png)

Check-in Administration Save New Configuration
...
> **Path:** Checking-out Check-in - NextGen > Types of Customization
...
| Look and Feel | Moderate | While Rock Next-Gen Check-in ships with one check-in theme, you can add your own with some basic knowledge of HTML/CSS and Less. |
...
> **Path:** Checking-out Check-in - NextGen > Sample Configurations
...
![Default Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/checkin-config-default.png)
...
![Large Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.13.0/images/checkin-config-large-a-v13.png)

Default Configuration

![Large Configuration](https://rockrms.blob.core.windows.net/documentation/Books/42/1.13.0/images/checkin-config-large-b-v13.png)
...
> **Path:** Checking-out Check-in - NextGen > Planning Your Configuration
