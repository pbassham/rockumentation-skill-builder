---
description: "Use when users need to understand label printing options for Rock check-in, including cloud printing, VPN tunnels, kiosk printing, and local network solutions"
source: "https://community.rockrms.com/documentation/bookcontent/10/372"
sourceLabel: Checking-out Check-in
---
> **Path:** Checking-out Check-in > Rock Cloud Printing
...
![VPN Tunnel Printing](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/vpn-tunnel-printing-v16.png)
...
![Kiosk Printing](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/kiosk-printing-v16.png)
...
![Local Network Printing](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/local-network-printing-v16.png)
...
![Rock Cloud Printing](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/rock-cloud-printing-v16.png)
...
![Set Up Proxy Device](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/set-up-proxy-device-in-rock-v16.png)
...
![Add Proxy Device to Printer](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/add-proxy-device-to-printer-v16.png)
...
![Cloud Printing Kiosk Configuration](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/cloud-printing-kiosk-configuration-v16.png)
...
![Rock Cloud Print Application](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/cloud-printing-rock-app-v16.png)
...
> **Path:** Checking-out Check-in > Allergies and Legal Notes
...
On the *Child Label* you'll see a notation that the child has an allergy or legal note in the system. Depending on the label used, the notation will be in the form of a letter ("A" for Allergy or "L" for Legal) or an icon. This label will be worn by the child and does not show the details of the allergy or legal note, for privacy reasons.

![Child Tag](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/label-child-text.png)

Child Label

The note label will print the complete note entered above for the benefit of the volunteer assisting with child check-in.

![Child Tag](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/label-notes.png)
...
> **Path:** Checking-out Check-in > Ability Levels
...
![Ability Levels](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/ability-level-v14.png)
...
![Ability Level Area Configuration](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/ability-level-area-v13.png)
...
![Ability Level Group Configuration](https://rockrms.blob.core.windows.net/documentation/Books/10/1.16.0/images/ability-level-group-v16.png)
