---
description: "Use when managing check-in phases, understanding checked-in vs present vs checked-out states, or configuring attendance tracking workflows"
source: "https://community.rockrms.com/documentation/bookcontent/10/372"
sourceLabel: Checking-out Check-in
---
> **Path:** Checking-out Check-in > Check-In Manager
...
![Cancel Check-in](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/check-in-manager-roster-cancel-v14.png)
...
![Present](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/check-in-manager-roster-present-v14.png)
...
![Checked-out](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/check-in-manager-roster-checked-out-v14.png)
...
![Check-in Manager Room Roster](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-roster-v14.png)
...
![Roster Block Settings](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-roster-block-settings-v16.png)
...
![Check-in Manager Person Profile](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-person-profile-v13.png)
...
![Check-in Manager Search](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-person-search-v12.png)
...
![Check-in Manager Live Metrics - Areas](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-live-metrics-areas-v15.png)
...
![Check-in Manager Live Metrics - Rooms](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-live-metrics-room-v12.png)
...
![Check-in Manager - Room List](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-room-list-v12.png)
...
![Check-in Manager - En Route](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-en-route-v12.png)
...
![Check-in Manager - Settings](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-settings-v12.png)
...
![Texting from Check-in Manager](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-SMS-from-profile-v16.png)
...
![Check-In Manager Profile Block Settings](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/checkin-manager-person-profile-SMS-block-setting-v16.png)
...
> **Path:** Checking-out Check-in > Device Manager
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/devicemanager-auth.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/devicemanager-main.png)
...
![](https://rockrms.blob.core.windows.net/documentation/Books/10/1.17.0/images/devicemanager-schedules.png)
