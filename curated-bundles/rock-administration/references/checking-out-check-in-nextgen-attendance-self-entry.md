---
description: Use when users need to understand how attendees can self-report their attendance for online services and add family members or co-watchers
source: "https://community.rockrms.com/documentation/bookcontent/42/350"
sourceLabel: Checking-out Check-in - NextGen
---
> **Path:** Checking-out Check-in - NextGen > Attendance Self Entry
...
![Attendance Self Entry - Known Person](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-known-person-v10.png)
...
![Attendance Self Entry - Person Information](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-unknown-person-v10.png)
...
![Attendance Self Entry - Other Watchers](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-other-watchers-v10.png)
...
![Attendance Self Entry - Create Account](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-create-account-v10.png)
...
![>Attendance Self Entry - Current Watchers](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-confirm-current-watchers-v10.png)
...
![Attendance Self Entry - Check-in Success](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-check-in-success-v10.png)
...
![>Attendance Self Entry - Block Settings 1](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-block-settings-1-v17.png)
...
![>Attendance Self Entry - Block Settings 2](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-block-settings-2-v17.png)
...
![>Attendance Self Entry - Block Settings 3](https://rockrms.blob.core.windows.net/documentation/Books/42/1.17.0/images/attendance-self-entry-block-settings-3-v17.png)
