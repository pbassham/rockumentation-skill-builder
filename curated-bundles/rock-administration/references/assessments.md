---
description: Use when needing to create assessment requests or send background check requests within Rock workflow actions
source: "https://community.rockrms.com/documentation/bookcontent/37/351"
sourceLabel: Assessments
---
> **Path:** Assessments

This skill catalogs the chapters of *Assessments* from the Rock RMS documentation.
